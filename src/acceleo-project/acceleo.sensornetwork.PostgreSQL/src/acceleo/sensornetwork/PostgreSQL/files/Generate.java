 ...
 *******************************************************************************/
package acceleo.sensornetwork.PostgreSQL.files;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/acceleo/sensornetwork/PostgreSQL/files/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(iot.sensornetwork.SensornetworkPackage.class)) {
            resourceSet.getPackageRegistry().put(iot.sensornetwork.SensornetworkPackage.eINSTANCE.getNsURI(), iot.sensornetwork.SensornetworkPackage.eINSTANCE);
        }
